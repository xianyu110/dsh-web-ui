...
const zh = {
  ...
  'settings.enabledHint': '关闭后不再挂载右侧文件树与预览列、不显示浮动展开按钮、不注册 /aionui-panel 路由，也不做工作区监视与 git 轮询；聚合包其余插件不受影响。',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'settings.enabledHint': 'When off, the Explorer and Preview columns are not mounted, the floating expand button disappears, the /aionui-panel routes are not registered, and workspace watching and git polling stop. The rest of the family bundle is unaffected.',
